...
export default function PageClient() {
    // Función para copiar correo y mostrar toast
  const copyGmail = () => {
    ...
    return (
        ...
        {/* Contenido encima */}
            <div className="relative z-10 flex flex-col min-h-screen justify-center items-center p-6">
                ...
                <nav
                    className="flex flex-wrap gap-4 justify-center sm:justify-start items-center mb-4"
                    aria-label="Links principales"
                >
                    <a
